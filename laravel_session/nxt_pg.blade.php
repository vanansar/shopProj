...
<link rel="stylesheet" href="{{url('public/assets/css/flexslider.css')}}" type="text/css" media="screen" /><!-- flexslider-CSS -->
...
<body>	
		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				...
				<!--<li class="dropdown head-dpdn">
						<a href="{{url('/sign_up')}}" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Sign Up</a>
					</li>-->
					  
					<li class="dropdown head-dpdn">
					@csrf
						<a href="{{url('/log_out')}}" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Log Out</a>
					</li>
                    ...
                    @if(!empty(Session::get('emailid'))) 
					<li class="dropdown head-dpdn">
						<a href="help.html"><i class="fa fa-question-circle" aria-hidden="true"></i>   {{ Session::get('emailid')}}</a>
					</li>
					@endif
					
					 
					<li class="dropdown head-dpdn">
						<a href="{{url('/nxt_pg')}}"><span class="active uls-trigger"><i class="fa fa-language" aria-hidden="true"></i>languages</span></a>
					</li>
	...
	<!-- Slider -->
				 ...
				 <div class="w3l-popular-ads-info">
					<div class="col-md-4 w3ls-portfolio-left">
						<div class="portfolio-img event-img">
							<img src="{{url('public/assets/images/ad1.jpg')}}" class="img-responsive" alt=""/>
					...
					<div class="col-md-4 w3ls-portfolio-left">
						<div class="portfolio-img event-img">
							<img src="{{url('public/assets/images/ad2.jpg')}}" class="img-responsive" alt=""/>
							 <div class="over-image"></div>
						</div>
						<div class="portfolio-description">
					...
					<div class="col-md-4 w3ls-portfolio-left">
						<div class="portfolio-img event-img">
							<img src="{{url('public/assets/images/ad3.jpg')}}" class="img-responsive" alt=""/>
							 <div class="over-image"></div>
						</div>
						<div class="portfolio-description">
					...
					<div class="col-md-4 w3ls-portfolio-left">
						<div class="portfolio-img event-img">
							<img src="{{url('public/assets/images/ad4.jpg')}}" class="img-responsive" alt=""/>
							 <div class="over-image"></div>
						</div>
						<div class="portfolio-description">
					...
					<div class="col-md-4 w3ls-portfolio-left">
						<div class="portfolio-img event-img">
							<img src="{{url('public/assets/images/ad5.jpg')}}" class="img-responsive" alt=""/>
							 <div class="over-image"></div>
						</div>
						<div class="portfolio-description">
					...
					<div class="col-md-4 w3ls-portfolio-left">
						<div class="portfolio-img event-img">
							<img src="{{url('public/assets/images/ad6.jpg')}}" class="img-responsive" alt=""/>
							 <div class="over-image"></div>
						</div>
						<div class="portfolio-description">
		...
		<!-- Navigation-Js-->
			...
			<script type="text/javascript" src="{{url('public/assets/js/classie.js')}}"></script>
		<!-- //Navigation-Js-->
		<!-- js -->
		...
		<!-- //language-select -->
		<script type="text/javascript" src="{{url('public/assets/js/jquery.flexisel.js')}}"></script><!-- flexisel-js -->	
