...
<link rel="stylesheet" href="{{url('public/assets/css/bootstrap.min.css')}}"><!-- bootstrap-CSS -->
<link rel="stylesheet" href="{{url('public/assets/css/bootstrap-select.css')}}"><!-- bootstrap-select-CSS -->
<link href="{{url('public/assets/css/style.css')}}" rel="stylesheet" type="text/css" media="all" /><!-- style.css -->
<link rel="stylesheet" href="{{url('public/assets/css/font-awesome.min.css')}}" /><!-- fontawesome-CSS -->
<link rel="stylesheet" href="{{url('public/assets/css/menu_sideslide.css')}}" type="text/css" media="all"><!-- Navigation-CSS -->
<!-- meta tags -->
...
<!--//fonts-->	
<!-- js -->
<script type="text/javascript" src="{{url('public/assets/js/jquery-1.10.2.js')}}"></script>

<!-- js -->
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="{{url('public/assets/js/bootstrap.js')}}"></script>
<script src="{{url('public/assets/js/bootstrap-select.js')}}"></script>
<script>
...
<!-- language-select -->
<script type="text/javascript" src="{{url('public/assets/js/jquery.leanModal.min.js')}}"></script>
<link href="{{url('public/assets/css/jquery.uls.css')}}" rel="stylesheet"/>
<link href="{{url('public/assets/css/jquery.uls.grid.css')}}" rel="stylesheet"/>
<link href="{{url('public/assets/css/jquery.uls.lcd.css')}}" rel="stylesheet"/>
<!-- Source -->
<script src="{{url('public/assets/js/jquery.uls.data.js')}}"></script>
<script src="{{url('public/assets/js/jquery.uls.data.utils.js')}}"></script>
<script src="{{url('public/assets/js/jquery.uls.lcd.js')}}"></script>
<script src="{{url('public/assets/js/jquery.uls.languagefilter.js')}}"></script>
<script src="{{url('public/assets/js/jquery.uls.regionfilter.js')}}"></script>
<script src="{{url('public/assets/js/jquery.uls.core.js')}}"></script>
<script>
			$( document ).ready( function() {
				$( '.uls-trigger' ).uls( {
			...
			<div class="w3ls-header-right">
				<ul>
					<li class="dropdown head-dpdn">
						<a href="{{url('/sign_in')}}" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Sign In</a>
					</li>
					<li class="dropdown head-dpdn">
		...
		<div class="container">
			<div class="agile-its-header">
				...
				<div class="agileits_search">
					<form action="{{url('/login_action')}}" id="reg_frm" method="post">
	...
	<!-- sign in form -->
	 <section>
		<div id="agileits-sign-in-page" class="sign-in-wrapper">
			...
			<h3>Sign Up</h3>
				<!--<form action="{{ url('/register') }}" id="reg_frm" method="post">
					<label style="color: #000">Name:</label>
                    <div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="name" style="font-weight:bold" name="name" type="text" >
						</div>
					</div>
					<label style="color: #000">Email:</label>
                    <div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="email" style="font-weight:bold" name="email" type="email" >
						</div>
					</div>
                    ...
                    <div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="phone" style="font-weight:bold" name="phone" type="text" >
						</div>
					</div>
					<label style="color: #000">Password:</label>
					 <div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="password" style="font-weight:bold" name="password" type="text" >
						</div>
					</div>
					<label style="color: #000">Confirm Password:</label>
						<div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="con_password" style="font-weight:bold" name="con_password" type="text" >
						</div>
					</div>
...
<form method="post" action="{{ url('/register') }}" id="form">
       ...
       <label style="color: #000">Phone:</label>
                    <div class="row">
					 ...
					 <div class="row">
						<div class="col-sm-12 form-group">
							<select class="input-lg" name="country" style="font-weight:bold"  id="country">
					 ...
					 <div class="row">
						<div class="col-sm-12 form-group">
							<select class="input-lg" name="state" style="font-weight:bold"  id="state">
								<option value="sel_country">Select State</option>
          ...
          <label style="color: #000">Password:</label>
					 <div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="password" style="font-weight:bold" name="password" type="password" >
						</div>
					</div>
					<label style="color: #000">Confirm Password:</label>
						<div class="row">
						<div class="col-sm-12 form-group">
							<input class="input-lg" id="con_password" style="font-weight:bold" name="con_password" type="password" >
						</div>
					</div>
        ...
        <script src="{{url('public/assets/js/jquery.validate.js')}}"></script>
